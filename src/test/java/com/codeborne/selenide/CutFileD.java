...
// creating new folder and uploading file to copy/cut into the folder
        ...
        $(byAttribute("data-element", "cM-4.1")).waitUntil(Condition.appear, 20000); //Cut button appears
        $(byAttribute("data-element", "cM-4.1")).click(); //Click cut button
        ...
        $(byText("test.log")).waitUntil(Condition.appear, 20000); //Assert that item is gone
