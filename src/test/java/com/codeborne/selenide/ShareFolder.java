...
//        sleep(5000);
    ...
    public void UserSharesFolder() {
        ...
        $("#saveFolderChanges").click(); //Click Save button
...
//  Login with user2
        ...
        $(".jsncounter").click();
//        $(".linkWord .nBtn .bblue").waitUntil(Condition.appear, 2000);
        $(".bblue").click();

        $(".jsncounter").waitUntil(Condition.disappear, 2000);
        $(byText("folder1")).waitUntil(Condition.appear, 2000);
