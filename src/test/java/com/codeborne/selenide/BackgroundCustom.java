...
//    open Design tab and change background
    ...
    $("#userBackgroundSelect").sendKeys("C:\\For_test\\test.png"); //Upload test file
    $(".userBg").waitUntil(Condition.appear, 20000);//custom background should appear
    sleep(1000);
...
//    $(".notify-msg").waitUntil(Condition.appear, 20000);
    ...
    $(".logFileExt").waitUntil(Condition.appear, 2000); // see the filename
...
//    $(".stdBG-1").waitUntil(Condition.appear, 2000);//Assert that background1 is  set
    $(".userBg").waitUntil(Condition.appear, 2000);//custom background should appear
    // logout
    $(".expand.absmid").click();
